...
residual(5) = lhs - rhs;
lhs = y(25);
rhs = T(4)*y(19)+y(25)*T(2)+y(18)+params(1)*params(11)*y(10)/y(55)+T(1)*(y(24)+(1-params(1))*y(28)+y(39)*params(1)*(1+y(45)));
residual(6) = lhs - rhs;
lhs = y(26);
...
residual(20) = lhs - rhs;
lhs = y(38)*T(13);
rhs = y(88)*params(2)*y(81)/y(57);
residual(21) = lhs - rhs;
lhs = y(38)*T(15);
rhs = params(2)*y(81)/y(86);
residual(22) = lhs - rhs;
lhs = y(39)*(1+y(45)+T(6))+y(41)-y(10)*(1-params(11))/y(55)+y(57)*(y(42)-y(11)/y(14))+y(43)-y(12)/y(55);
rhs = y(40)*y(51)-y(62)-y(57)*params(21)/2*T(16);
residual(23) = lhs - rhs;
lhs = y(44);
...
residual(29) = lhs - rhs;
lhs = y(27);
rhs = y(27)*y(52)*T(22)+T(23)*T(24);
residual(30) = lhs - rhs;
lhs = y(23);
rhs = (1-params(14))*y(6)+y(24)*T(21);
residual(31) = lhs - rhs;
lhs = y(25);
rhs = y(16)*T(25)*T(26);
residual(32) = lhs - rhs;
...
rhs = y(54)*(y(54)-params(38))-T(27)/(y(25)*y(56));
residual(35) = lhs - rhs;
lhs = y(54);
rhs = y(55)*y(56)/y(13);
residual(36) = lhs - rhs;
lhs = y(25)*y(56);
rhs = T(2)+y(21)+y(24)+y(56)*y(18)+(1-params(1))*y(57)*(y(33)-y(5)*y(9))+params(1)*y(57)*(y(42)-y(11))+(1-params(1))*y(57)*params(20)/2*T(28)+(1-params(1))*y(57)*params(19)/2*T(29)+T(16)*params(1)*y(57)*params(21)/2;
residual(37) = lhs - rhs;
lhs = 1;
