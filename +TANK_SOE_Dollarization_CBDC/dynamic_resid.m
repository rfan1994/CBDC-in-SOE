...
residual(9) = lhs - rhs;
lhs = y(27);
rhs = params(2)*y(78)*y(48)/y(85);
residual(10) = lhs - rhs;
lhs = y(27)*(1+(1-params(1))*params(20)*((1-params(1))*y(31)-params(23)));
rhs = params(2)*y(78)*y(49)*y(87)/y(57);
residual(11) = lhs - rhs;
lhs = y(27);
rhs = params(2)*y(78)*y(59)/y(85);
residual(12) = lhs - rhs;
...
residual(16) = y(36);
lhs = y(37);
rhs = y(28)^(1-params(3))/(1-params(3))-params(4)*y(29)^(1+params(5))/(1+params(5))+params(2)*y(79);
residual(17) = lhs - rhs;
lhs = y(39)^(-params(3));
...
residual(20) = lhs - rhs;
lhs = y(38)*(T(10)+params(1)*params(21)*(params(1)*y(42)-params(24)));
rhs = y(87)*params(2)*y(80)*(1-params(11))/y(57);
residual(21) = lhs - rhs;
lhs = y(38)*T(12);
rhs = params(2)*y(80)/y(85);
residual(22) = lhs - rhs;
lhs = y(39)*(1+y(45)+T(5))+y(41)-y(10)*(1-params(11))/y(55)+y(57)*(y(42)-y(57)*y(42)*(1-params(11))/y(14))+y(43)-y(12)/y(55);
rhs = y(40)*y(51)-y(62)-y(57)*params(21)/2*T(13);
residual(23) = lhs - rhs;
lhs = y(44);
rhs = T(15)^(params(12)/(params(12)-1));
residual(24) = lhs - rhs;
lhs = y(45);
...
residual(26) = lhs - rhs;
lhs = y(47);
rhs = y(39)^(1-params(3))/(1-params(3))-params(4)*y(40)^(1+params(5))/(1+params(5))+params(2)*y(81);
residual(27) = lhs - rhs;
lhs = y(48);
rhs = T(16)/T(17);
residual(28) = lhs - rhs;
...
residual(29) = lhs - rhs;
lhs = y(27);
rhs = y(27)*y(52)*T(19)+T(20)*T(21);
residual(30) = lhs - rhs;
lhs = y(23);
rhs = (1-params(14))*y(6)+y(24)*T(18);
residual(31) = lhs - rhs;
lhs = y(25);
rhs = y(16)*T(22)*T(23);
residual(32) = lhs - rhs;
...
rhs = y(54)*(y(54)-params(38))-T(24)/(y(25)*y(56));
residual(35) = lhs - rhs;
lhs = y(54);
rhs = y(55)*y(56)/y(13);
residual(36) = lhs - rhs;
lhs = T(1)*y(25)*y(56);
rhs = T(13)*params(1)*y(57)*params(21)/2+(1-params(1))*y(57)*params(20)/2*T(26)+(1-params(1))*y(57)*params(19)/2*T(25)+params(1)*params(11)*(y(10)/y(55)+y(57)*y(11)/y(14))+params(1)*y(57)*(y(42)-y(11))+(1-params(1))*y(57)*(y(33)-y(5)*y(9))+y(56)*y(18)+y(24)+(1-params(1))*y(28)+y(39)*params(1)*(1+y(45));
residual(37) = lhs - rhs;
lhs = 1;
