...
residual(5) = lhs - rhs;
lhs = y(25);
rhs = T(4)*y(19)+y(25)*T(2)+y(18)+params(1)*params(11)*(y(10)/y(55)+y(57)*y(11)/y(14))+T(1)*(y(24)+(1-params(1))*y(28)+y(39)*params(1)*(1+y(45)));
residual(6) = lhs - rhs;
lhs = y(26);
...
residual(22) = lhs - rhs;
lhs = y(39)*(1+y(45)+T(6))+y(41)-y(10)*(1-params(11))/y(55)+y(57)*(y(42)-y(11)*(1-params(11))/y(14))+y(43)-y(12)/y(55);
