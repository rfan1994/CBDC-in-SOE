...
residual(5) = lhs - rhs;
lhs = y(24);
rhs = T(4)*y(18)+y(24)*T(2)+y(17)+params(1)*params(11)*y(9)/y(54)+T(1)*(y(23)+(1-params(1))*y(27)+y(38)*params(1)*(1+y(44)));
residual(6) = lhs - rhs;
lhs = y(25);
...
residual(22) = lhs - rhs;
lhs = y(38)*(1+y(44)+T(6))+y(40)-y(9)*(1-params(11))/y(54)+y(56)*(y(41)-y(10)/y(13))+y(42)-y(11)/y(54);
rhs = y(39)*y(50)-y(61)-y(56)*params(21)/2*T(16);
residual(23) = lhs - rhs;
lhs = y(43);
rhs = T(18)^(params(12)/(params(12)-1));
residual(24) = lhs - rhs;
lhs = y(44);
...
residual(29) = lhs - rhs;
lhs = y(26);
rhs = y(26)*y(51)*T(22)+T(23)*T(24);
residual(30) = lhs - rhs;
lhs = y(22);
rhs = (1-params(14))*y(5)+y(23)*T(21);
residual(31) = lhs - rhs;
lhs = y(24);
rhs = y(15)*T(25)*T(26);
residual(32) = lhs - rhs;
...
rhs = y(53)*(y(53)-params(38))-T(27)/(y(24)*y(55));
residual(35) = lhs - rhs;
lhs = y(53);
rhs = y(54)*y(55)/y(12);
residual(36) = lhs - rhs;
lhs = y(24)*y(55);
rhs = T(16)*params(1)*y(56)*params(21)/2+(1-params(1))*y(56)*params(19)/2*T(28)+T(2)+y(20)+y(23)+y(55)*y(17)+(1-params(1))*y(56)*(y(32)-y(4)*y(8))+params(1)*y(56)*(y(41)-y(10))+(1-params(1))*y(56)*params(20)/2*T(30);
residual(37) = lhs - rhs;
lhs = 1;
