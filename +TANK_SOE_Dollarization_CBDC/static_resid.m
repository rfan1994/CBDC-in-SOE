...
residual(5) = lhs - rhs;
lhs = y(10);
rhs = T(2)*y(4)+y(10)*T(3)+y(3)+params(1)*params(11)*y(26)/y(40)+T(4)*(y(9)+(1-params(1))*y(13)+y(24)*params(1)*(1+y(30)));
residual(6) = lhs - rhs;
lhs = y(11);
...
residual(22) = lhs - rhs;
lhs = y(24)*(1+y(30)+T(5))+y(26)-y(26)*(1-params(11))/y(40)+y(42)*(y(27)-y(27)/y(42))+y(28)-y(28)/y(40);
