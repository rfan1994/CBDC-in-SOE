...
residual(5) = lhs - rhs;
lhs = y(10);
rhs = T(2)*y(4)+y(10)*T(3)+y(3)+params(1)*params(11)*(y(26)/y(40)+y(27))+T(4)*(y(9)+(1-params(1))*y(13)+y(24)*params(1)*(1+y(30)));
residual(6) = lhs - rhs;
lhs = y(11);
...
residual(22) = lhs - rhs;
lhs = y(24)*(1+y(30)+T(5))+y(26)-y(26)*(1-params(11))/y(40)+y(42)*(y(27)-y(27)*(1-params(11))/y(42))+y(28)-y(28)/y(40);
rhs = y(25)*y(36)-y(47)-y(42)*params(21)/2*T(15);
residual(23) = lhs - rhs;
lhs = y(29);
...
residual(27) = lhs - rhs;
lhs = y(33);
rhs = (y(12)*params(2)*(y(35)+(1-params(14))*y(37))-y(12)*(y(37)-1))/T(18);
residual(28) = lhs - rhs;
lhs = y(34);
...
residual(36) = lhs - rhs;
lhs = y(10)*y(41);
rhs = T(3)+y(6)+y(9)+y(41)*y(3)+(1-params(1))*y(42)*(y(18)-y(18)*y(5))+(1-params(1))*y(42)*params(20)/2*T(21)+(1-params(1))*y(42)*params(19)/2*T(22)+T(15)*params(1)*y(42)*params(21)/2;
residual(37) = lhs - rhs;
lhs = 1;
