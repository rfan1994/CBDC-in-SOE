...
residual(5) = lhs - rhs;
lhs = y(10);
rhs = T(1)*(y(13)*(1-params(1))*(1+y(20))+y(24)*params(1)*(1+y(30))+y(9))+y(3)+y(10)*T(2)+T(4)*y(4);
residual(6) = lhs - rhs;
lhs = y(11);
rhs = (1-params(1))*y(22)+params(1)*y(32);
residual(7) = lhs - rhs;
lhs = y(13)^(-params(3));
rhs = y(12)*(1+y(20)+y(21)+params(25));
residual(8) = lhs - rhs;
lhs = y(14)^params(5);
rhs = y(12)*y(36)/params(4);
residual(9) = lhs - rhs;
lhs = y(12)*(1-y(21)*y(13)/y(19));
rhs = y(12)*params(2)*y(33)/y(40);
residual(10) = lhs - rhs;
lhs = y(12)*(1+(1-params(1))*params(20)*((1-params(1))*y(16)-params(23))-y(21)*y(13)/y(19));
...
residual(14) = lhs - rhs;
lhs = y(20);
rhs = y(13)*y(2)*params(9)/y(19)+y(19)*params(10)/y(13)-T(6);
residual(15) = lhs - rhs;
lhs = y(21);
rhs = y(13)*y(2)*params(9)/y(19)-y(19)*params(10)/y(13);
residual(16) = lhs - rhs;
lhs = y(22);
rhs = y(13)^(1-params(3))/(1-params(3))-params(4)*y(14)^(1+params(5))/(1+params(5))+y(22)*params(2);
residual(17) = lhs - rhs;
lhs = y(24)^(-params(3));
rhs = y(23)*(1+y(30)+y(31)+T(7));
residual(18) = lhs - rhs;
lhs = y(25)^params(5);
...
residual(22) = lhs - rhs;
lhs = y(24)*(1+y(30)+T(7))+y(26)-y(26)*(1-params(11))/y(40)+y(42)*(y(27)-(1-params(11))*y(27))+y(28)-y(28)/y(40);
rhs = y(25)*y(36)-y(47)-y(42)*params(21)/2*T(17);
residual(23) = lhs - rhs;
lhs = y(29);
rhs = T(19)^(params(12)/(params(12)-1));
residual(24) = lhs - rhs;
lhs = y(30);
rhs = y(24)*y(2)*params(9)/y(29)+params(10)*y(29)/y(24)-T(6);
residual(25) = lhs - rhs;
lhs = y(31);
rhs = y(24)*y(2)*params(9)/y(29)-params(10)*y(29)/y(24);
residual(26) = lhs - rhs;
lhs = y(32);
rhs = y(24)^(1-params(3))/(1-params(3))-params(4)*y(25)^(1+params(5))/(1+params(5))+y(32)*params(2);
residual(27) = lhs - rhs;
lhs = y(33);
rhs = T(21)/T(22)-y(44)*T(23);
residual(28) = lhs - rhs;
lhs = y(34);
rhs = T(21)/(y(12)*params(2))-(1+(1-params(1))*params(20)*((1-params(1))*y(16)-params(23)))*y(5)*T(23)/T(5);
residual(29) = lhs - rhs;
lhs = y(12);
rhs = y(12)*y(37);
residual(30) = lhs - rhs;
...
residual(36) = lhs - rhs;
lhs = y(10)*y(41);
rhs = T(2)+y(6)+y(9)+y(41)*y(3)+(1-params(1))*y(42)*(y(18)-y(18)*y(5))+(1-params(1))*y(42)*params(20)/2*T(26)+(1-params(1))*y(42)*params(19)/2*T(27)+T(17)*params(1)*y(42)*params(21)/2;
residual(37) = lhs - rhs;
lhs = 1;
