...
residual(4) = lhs - rhs;
lhs = y(8);
rhs = (1-params(1))*(y(15)+y(42)*y(16));
residual(5) = lhs - rhs;
lhs = y(10)*T(1);
rhs = T(2)*y(4)+y(3)+T(3)*T(4);
residual(6) = lhs - rhs;
lhs = y(11);
...
residual(10) = lhs - rhs;
lhs = y(12)*(1+(1-params(1))*params(20)*((1-params(1))*y(16)-params(23)));
rhs = y(12)*params(2)*y(34);
residual(11) = lhs - rhs;
lhs = y(12);
...
residual(20) = lhs - rhs;
lhs = y(23)*(T(10)+params(1)*params(21)*(params(1)*y(27)-params(24)));
rhs = params(2)*y(23)*(1-params(11));
residual(21) = lhs - rhs;
lhs = y(23)*T(12);
rhs = params(2)*y(23)/y(40);
residual(22) = lhs - rhs;
lhs = y(24)*(1+y(30)+T(5))+y(26)-y(26)*(1-params(11))/y(40)+y(42)*(y(27)-y(27)*(1-params(11)))+y(28)-y(28)/y(40);
rhs = y(25)*y(36)-y(47)-y(42)*params(21)/2*T(13);
residual(23) = lhs - rhs;
lhs = y(29);
...
residual(27) = lhs - rhs;
lhs = y(33);
rhs = (y(12)*params(2)*(y(35)+(1-params(14))*y(37))-y(12)*(y(37)-1))/T(16);
residual(28) = lhs - rhs;
lhs = y(34);
...
residual(36) = lhs - rhs;
lhs = T(1)*y(10)*y(41);
rhs = T(13)*params(1)*y(42)*params(21)/2+(1-params(1))*y(42)*params(20)/2*T(19)+(1-params(1))*y(42)*params(19)/2*T(20)+(y(26)/y(40)+y(27))*params(1)*params(11)+(1-params(1))*y(42)*(y(18)-y(18)*y(5))+y(41)*y(3)+y(9)+(1-params(1))*y(13)+y(24)*params(1)*(1+y(30));
residual(37) = lhs - rhs;
lhs = 1;
...
residual(44) = lhs - rhs;
lhs = y(45);
rhs = y(13)*(1-params(1))*params(25)+y(24)*y(28)*params(1)*params(25)/y(29);
residual(45) = lhs - rhs;
lhs = y(46);
rhs = T(27);
residual(46) = lhs - rhs;
