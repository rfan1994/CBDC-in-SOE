...
residual(36) = lhs - rhs;
lhs = y(10)*y(41);
rhs = T(15)*params(1)*y(42)*params(21)/2+(1-params(1))*y(42)*params(19)/2*T(21)+T(3)+y(6)+y(9)+y(41)*y(3)+(1-params(1))*y(42)*(y(18)-y(18)*y(5))+(1-params(1))*y(42)*params(20)/2*T(22);
residual(37) = lhs - rhs;
lhs = 1;
