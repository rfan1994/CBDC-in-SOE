...
residual(25) = lhs - rhs;
lhs = y(24)*(1+y(30))+y(26)-y(26)*(1-params(11))/y(40);
rhs = y(25)*y(36)-y(47)-y(42)*params(21)/2*T(7);
residual(26) = lhs - rhs;
lhs = y(32);
rhs = y(24)^(1-params(3))/(1-params(3))-params(4)*y(25)^(1+params(5))/(1+params(5))+y(32)*params(2);
residual(27) = lhs - rhs;
lhs = y(33);
rhs = (y(12)*params(2)*(y(35)+(1-params(14))*y(37))-y(12)*(y(37)-1))/T(8);
residual(28) = lhs - rhs;
lhs = y(34);
...
residual(36) = lhs - rhs;
lhs = T(1)*y(10)*y(41);
rhs = (1-params(1))*y(42)*params(19)/2*T(11)+(1-params(1))*y(42)*(y(18)-y(18)*y(5))+y(41)*y(3)+y(9)+(1-params(1))*y(13)+y(24)*params(1)*(1+y(30))+y(26)/y(40)*params(1)*params(11)+(1-params(1))*y(42)*params(20)/2*T(12)+T(7)*params(1)*y(42)*params(21)/2;
residual(37) = lhs - rhs;
lhs = 1;
