...
residual(5) = lhs - rhs;
lhs = y(10);
rhs = T(2)*y(4)+y(10)*T(3)+y(3)+params(1)*params(11)*y(25)/y(37)+T(4)*(y(9)+(1-params(1))*y(13)+y(23)*params(1)*(1+y(28)));
residual(6) = lhs - rhs;
lhs = y(11);
...
residual(23) = lhs - rhs;
lhs = y(25)-y(25)*(1-params(11))/y(37)+y(23)*(1+y(28));
rhs = y(24)*y(33)-y(44);
residual(24) = lhs - rhs;
lhs = y(30);
...
residual(25) = lhs - rhs;
lhs = y(31);
rhs = (y(12)*params(2)*(y(32)+(1-params(14))*y(34))-y(12)*(y(34)-1))/T(7);
residual(26) = lhs - rhs;
lhs = y(12);
rhs = y(12)*y(34);
residual(27) = lhs - rhs;
...
residual(33) = lhs - rhs;
lhs = y(10)*y(38);
rhs = T(3)+y(6)+y(9)+y(38)*y(3)+(1-params(1))*y(39)*T(10);
residual(34) = lhs - rhs;
lhs = 1;
