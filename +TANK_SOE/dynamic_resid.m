...
residual(5) = lhs - rhs;
lhs = y(23)*T(1);
rhs = T(3)*y(17)+y(16)+T(2)*(y(22)+(1-params(1))*y(26)+params(1)*(y(37)*(1+y(43))+params(11)*y(10)/y(53)));
residual(6) = lhs - rhs;
lhs = y(24);
...
residual(9) = lhs - rhs;
lhs = y(25);
rhs = params(2)*y(76)*y(46)/y(83);
residual(10) = lhs - rhs;
residual(11) = y(29);
lhs = y(25);
rhs = params(2)*y(76)*y(57)/y(83);
residual(12) = lhs - rhs;
...
residual(16) = y(34);
lhs = y(35);
rhs = y(26)^(1-params(3))/(1-params(3))-params(4)*y(27)^(1+params(5))/(1+params(5))+params(2)*y(77);
residual(17) = lhs - rhs;
lhs = y(37)^(-params(3));
...
residual(19) = lhs - rhs;
lhs = y(36)*T(24);
rhs = params(2)*y(78)*(1-params(11))/y(83);
residual(20) = lhs - rhs;
residual(21) = y(40);
residual(22) = y(41);
lhs = y(42);
rhs = (T(5))^(params(12)/(params(12)-1));
residual(23) = lhs - rhs;
lhs = y(43);
...
residual(25) = lhs - rhs;
lhs = y(37)*(1+y(43))+y(39)-y(10)*(1-params(11))/y(53);
rhs = y(38)*y(49)-y(60)-y(55)*params(21)/2*T(25);
residual(26) = lhs - rhs;
lhs = y(45);
rhs = y(37)^(1-params(3))/(1-params(3))-params(4)*y(38)^(1+params(5))/(1+params(5))+params(2)*y(79);
residual(27) = lhs - rhs;
lhs = y(46);
rhs = T(6)/T(7);
residual(28) = lhs - rhs;
...
residual(29) = lhs - rhs;
lhs = y(25);
rhs = y(25)*y(50)*T(9)+T(10)*T(11);
residual(30) = lhs - rhs;
lhs = y(21);
rhs = (1-params(14))*y(6)+y(22)*T(8);
residual(31) = lhs - rhs;
lhs = y(23);
rhs = y(14)*T(12)*T(13);
residual(32) = lhs - rhs;
...
rhs = y(52)*(y(52)-params(38))-T(14)/(y(23)*y(54));
residual(35) = lhs - rhs;
lhs = y(52);
rhs = y(53)*y(54)/y(11);
residual(36) = lhs - rhs;
lhs = T(1)*y(23)*y(54);
rhs = (1-params(1))*y(55)*params(19)/2*T(15)+(1-params(1))*y(55)*(y(31)-y(5)*y(9))+y(54)*y(16)+y(22)+(1-params(1))*y(26)+y(37)*params(1)*(1+y(43))+y(10)/y(53)*params(1)*params(11)+(1-params(1))*y(55)*params(20)/2*T(26)+params(1)*y(55)*params(21)/2*T(25);
residual(37) = lhs - rhs;
lhs = 1;
