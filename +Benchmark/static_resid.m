...
residual(10) = lhs - rhs;
lhs = y(11)*(1+(1-params(1))*params(19)*((1-params(1))*y(16)-params(22)));
...
residual(16) = lhs - rhs;
lhs = y(22);
rhs = (y(11)*params(2)*(y(23)+(1-params(14))*y(25))-y(11)*(y(25)-1))/T(5);
residual(17) = lhs - rhs;
lhs = y(11);
rhs = y(11)*y(25);
residual(18) = lhs - rhs;
lhs = y(7);
rhs = y(8)+y(7)*(1-params(14));
residual(19) = lhs - rhs;
lhs = y(9);
rhs = y(1)*T(6)*T(7);
residual(20) = lhs - rhs;
lhs = y(23);
rhs = y(9)*params(13)*y(26)/y(7);
residual(21) = lhs - rhs;
lhs = y(24);
rhs = y(9)*(1-params(13))*y(26)/y(6);
residual(22) = lhs - rhs;
lhs = params(16)/params(15)*(y(26)/y(29)-(params(16)-1)/params(16));
rhs = y(27)*(y(27)-params(38))-y(9)*y(29)*y(27)*(y(27)-params(38))*params(2)/(y(9)*y(29));
residual(23) = lhs - rhs;
lhs = y(27);
rhs = y(28);
residual(24) = lhs - rhs;
lhs = T(1)*y(9)*y(29);
rhs = y(5)+y(8)+y(29)*y(2)+(1-params(1))*y(30)*T(8);
residual(25) = lhs - rhs;
lhs = 1;
...
residual(27) = lhs - rhs;
lhs = log(y(3));
rhs = (1-params(44))*log(params(49))+log(y(3))*params(44)+x(3);
residual(28) = lhs - rhs;
lhs = log(y(4));
rhs = (1-params(45))*log(params(50))+log(y(4))*params(45)+x(4);
residual(29) = lhs - rhs;
lhs = y(32)/params(37);
