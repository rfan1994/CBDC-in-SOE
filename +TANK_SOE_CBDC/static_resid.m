...
residual(5) = lhs - rhs;
lhs = y(10)*T(1);
rhs = T(2)*y(4)+y(3)+T(3)*(y(9)+(1-params(1))*y(13)+params(1)*(y(24)*(1+y(30))+params(11)*y(26)/y(40)));
residual(6) = lhs - rhs;
lhs = y(11);
...
residual(25) = lhs - rhs;
lhs = y(24)*(1+y(30)+T(4))+y(26)-y(26)*(1-params(11))/y(40)+y(28)-y(28)/y(40);
...
residual(27) = lhs - rhs;
lhs = y(33);
rhs = (y(12)*params(2)*(y(35)+(1-params(14))*y(37))-y(12)*(y(37)-1))/T(15);
residual(28) = lhs - rhs;
lhs = y(34);
...
residual(36) = lhs - rhs;
lhs = T(1)*y(10)*y(41);
rhs = (1-params(1))*y(42)*params(19)/2*T(18)+(1-params(1))*y(42)*(y(18)-y(18)*y(5))+y(41)*y(3)+y(9)+(1-params(1))*y(13)+y(24)*params(1)*(1+y(30))+y(26)/y(40)*params(1)*params(11)+(1-params(1))*y(42)*params(20)/2*T(19)+T(14)*params(1)*y(42)*params(21)/2;
residual(37) = lhs - rhs;
lhs = 1;
