...
residual(5) = lhs - rhs;
lhs = y(24)*T(1);
rhs = T(3)*y(18)+y(17)+T(2)*(y(23)+(1-params(1))*y(27)+params(1)*(y(38)*(1+y(44))+params(11)*y(10)/y(54)));
residual(6) = lhs - rhs;
lhs = y(25);
...
residual(25) = lhs - rhs;
lhs = y(38)*(1+y(44)+T(5))+y(40)-y(10)*(1-params(11))/y(54)+y(42)-y(11)/y(54);
rhs = y(39)*y(50)-y(61)-y(56)*params(21)/2*T(33);
residual(26) = lhs - rhs;
lhs = y(46);
...
residual(29) = lhs - rhs;
lhs = y(26);
rhs = y(26)*y(51)*T(15)+T(16)*T(17);
residual(30) = lhs - rhs;
lhs = y(22);
rhs = (1-params(14))*y(6)+y(23)*T(14);
residual(31) = lhs - rhs;
lhs = y(24);
rhs = y(15)*T(18)*T(19);
residual(32) = lhs - rhs;
...
rhs = y(53)*(y(53)-params(38))-T(20)/(y(24)*y(55));
residual(35) = lhs - rhs;
lhs = y(53);
rhs = y(54)*y(55)/y(12);
residual(36) = lhs - rhs;
lhs = T(1)*y(24)*y(55);
rhs = (1-params(1))*y(56)*params(19)/2*T(21)+(1-params(1))*y(56)*(y(32)-y(5)*y(9))+y(55)*y(17)+y(23)+(1-params(1))*y(27)+y(38)*params(1)*(1+y(44))+y(10)/y(54)*params(1)*params(11)+(1-params(1))*y(56)*params(20)/2*T(34)+params(1)*y(56)*params(21)/2*T(33);
residual(37) = lhs - rhs;
lhs = 1;
