...
T(19) = (y(41)/params(37))^params(33);
T(20) = (y(37)/params(38))^params(34);
T(21) = (y(10)*y(38)/params(39))^params(35);
T(22) = (y(40)/params(40))^params(36);
T(23) = T(20)*T(21)*T(22);
T(24) = T(23)^(1-params(33));
T(25) = y(3)-y(42)+(1-params(1))*(y(16)*y(41)/y(37)-y(16))+params(1)*(y(26)/y(37)+y(25)/y(37)-y(25)-y(26));
