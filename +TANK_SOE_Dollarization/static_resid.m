...
residual(21) = lhs - rhs;
residual(22) = y(28);
lhs = y(42)*(y(27)-y(27)*(1-params(11))/y(42))+y(26)-y(26)*(1-params(11))/y(40)+y(24)*(1+y(30));
rhs = y(25)*y(36)-y(47)-y(42)*params(21)/2*T(11);
residual(23) = lhs - rhs;
lhs = y(29);
rhs = T(13)^(params(12)/(params(12)-1));
residual(24) = lhs - rhs;
lhs = y(30);
...
residual(27) = lhs - rhs;
lhs = y(33);
rhs = (y(12)*params(2)*(y(35)+(1-params(14))*y(37))-y(12)*(y(37)-1))/T(14);
residual(28) = lhs - rhs;
lhs = y(34);
...
residual(36) = lhs - rhs;
lhs = y(10)*y(41);
rhs = T(3)+y(6)+y(9)+y(41)*y(3)+(1-params(1))*y(42)*(y(18)-y(18)*y(5))+(1-params(1))*y(42)*params(20)/2*T(17)+(1-params(1))*y(42)*params(19)/2*T(18)+T(11)*params(1)*y(42)*params(21)/2;
residual(37) = lhs - rhs;
lhs = 1;
