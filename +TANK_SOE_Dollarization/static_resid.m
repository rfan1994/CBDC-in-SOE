...
residual(20) = lhs - rhs;
lhs = y(23)*(T(7)+params(1)*params(21)*(params(1)*y(27)-params(24)));
rhs = params(2)*y(23)*(1-params(11));
residual(21) = lhs - rhs;
residual(22) = y(28);
lhs = y(42)*(y(27)-y(27)*(1-params(11)))+y(24)*(1+y(30))+y(26)-y(26)*(1-params(11))/y(40);
rhs = y(25)*y(36)-y(47)-y(42)*params(21)/2*T(8);
residual(23) = lhs - rhs;
lhs = y(29);
rhs = (T(9))^(params(12)/(params(12)-1));
residual(24) = lhs - rhs;
lhs = y(30);
...
residual(27) = lhs - rhs;
lhs = y(33);
rhs = (y(12)*params(2)*(y(35)+(1-params(14))*y(37))-y(12)*(y(37)-1))/T(10);
residual(28) = lhs - rhs;
lhs = y(34);
...
residual(36) = lhs - rhs;
lhs = T(1)*y(10)*y(41);
rhs = T(8)*params(1)*y(42)*params(21)/2+(1-params(1))*y(42)*params(20)/2*T(13)+(1-params(1))*y(42)*params(19)/2*T(14)+(y(26)/y(40)+y(27))*params(1)*params(11)+(1-params(1))*y(42)*(y(18)-y(18)*y(5))+y(41)*y(3)+y(9)+(1-params(1))*y(13)+y(24)*params(1)*(1+y(30));
residual(37) = lhs - rhs;
lhs = 1;
