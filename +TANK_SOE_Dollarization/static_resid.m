...
residual(5) = lhs - rhs;
lhs = y(10);
rhs = T(2)*y(4)+y(10)*T(3)+y(3)+params(11)*y(26)/y(40)+T(4)*(y(9)+(1-params(1))*y(13)+y(24)*params(1)*(1+y(30)));
residual(6) = lhs - rhs;
lhs = y(11);
...
residual(21) = lhs - rhs;
residual(22) = y(28);
lhs = y(42)*(y(27)-(1-params(11))*y(27))+y(26)-y(26)*(1-params(11))/y(40)+y(24)*(1+y(30));
...
residual(36) = lhs - rhs;
lhs = y(10)*y(41);
rhs = T(11)*params(1)*y(42)*params(21)/2+(1-params(1))*y(42)*params(19)/2*T(17)+T(3)+y(6)+y(9)+y(41)*y(3)+(1-params(1))*y(42)*(y(18)-y(18)*y(5))+(1-params(1))*y(42)*params(20)/2*T(18);
residual(37) = lhs - rhs;
lhs = 1;
