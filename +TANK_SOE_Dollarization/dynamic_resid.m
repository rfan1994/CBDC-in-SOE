...
residual(5) = lhs - rhs;
lhs = y(23);
rhs = T(4)*y(17)+y(23)*T(2)+y(16)+params(1)*params(11)*y(9)/y(53)+T(1)*(y(22)+(1-params(1))*y(26)+y(37)*params(1)*(1+y(43)));
residual(6) = lhs - rhs;
lhs = y(24);
...
residual(20) = lhs - rhs;
lhs = y(36)*T(24);
rhs = y(86)*params(2)*y(79)/y(55);
residual(21) = lhs - rhs;
residual(22) = y(41);
lhs = y(55)*(y(40)-y(10)/y(12))+y(39)-y(9)*(1-params(11))/y(53)+y(37)*(1+y(43));
rhs = y(38)*y(49)-y(60)-y(55)*params(21)/2*T(9);
residual(23) = lhs - rhs;
lhs = y(42);
...
residual(29) = lhs - rhs;
lhs = y(25);
rhs = y(25)*y(50)*T(15)+T(16)*T(17);
residual(30) = lhs - rhs;
lhs = y(21);
rhs = (1-params(14))*y(5)+y(22)*T(14);
residual(31) = lhs - rhs;
lhs = y(23);
rhs = y(14)*T(18)*T(19);
residual(32) = lhs - rhs;
lhs = y(48);
rhs = y(23)*params(13)*y(51)/y(5);
residual(33) = lhs - rhs;
lhs = y(49);
rhs = y(23)*(1-params(13))*y(51)/y(20);
residual(34) = lhs - rhs;
lhs = params(16)/params(15)*(y(51)/y(54)-(params(16)-1)/params(16));
rhs = y(52)*(y(52)-params(38))-T(20)/(y(23)*y(54));
residual(35) = lhs - rhs;
lhs = y(52);
rhs = y(53)*y(54)/y(11);
residual(36) = lhs - rhs;
lhs = y(23)*y(54);
rhs = T(9)*params(1)*y(55)*params(21)/2+(1-params(1))*y(55)*params(19)/2*T(21)+T(2)+y(19)+y(22)+y(54)*y(16)+(1-params(1))*y(55)*(y(31)-y(4)*y(8))+params(1)*y(55)*(y(40)-y(10))+(1-params(1))*y(55)*params(20)/2*T(25);
residual(37) = lhs - rhs;
lhs = 1;
