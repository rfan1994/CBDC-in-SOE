...
residual(5) = lhs - rhs;
lhs = y(23);
rhs = T(4)*y(17)+y(23)*T(2)+y(16)+params(11)*y(9)/y(53)+T(1)*(y(22)+(1-params(1))*y(26)+y(37)*params(1)*(1+y(43)));
residual(6) = lhs - rhs;
lhs = y(24);
...
residual(20) = lhs - rhs;
lhs = y(36)*T(34);
rhs = y(86)*params(2)*y(79)*(1-params(11))/y(55);
residual(21) = lhs - rhs;
residual(22) = y(41);
lhs = y(55)*(y(40)-(1-params(11))*y(10))+y(39)-y(9)*(1-params(11))/y(53)+y(37)*(1+y(43));
rhs = y(38)*y(49)-y(60)-T(11)*T(12);
residual(23) = lhs - rhs;
lhs = y(42);
...
residual(29) = lhs - rhs;
lhs = y(25);
rhs = y(25)*y(50)*T(19)+T(21)*T(22);
residual(30) = lhs - rhs;
lhs = y(21);
rhs = (1-params(14))*y(5)+y(22)*T(18);
residual(31) = lhs - rhs;
lhs = y(23);
rhs = y(14)*T(23)*T(24);
residual(32) = lhs - rhs;
...
residual(34) = lhs - rhs;
lhs = T(25)*(y(51)/y(54)-(params(16)-1)/params(16));
rhs = y(52)*(y(52)-params(38))-T(29)/(y(23)*y(54));
residual(35) = lhs - rhs;
lhs = y(52);
rhs = y(53)*y(54)/y(11);
residual(36) = lhs - rhs;
lhs = y(23)*y(54);
rhs = T(12)*params(1)*T(11)+T(30)*T(31)+T(2)+y(19)+y(22)+y(54)*y(16)+(1-params(1))*y(55)*(y(31)-y(4)*y(8))+params(1)*y(55)*(y(40)-y(10))+(1-params(1))*y(55)*params(20)/2*T(35);
residual(37) = lhs - rhs;
lhs = 1;
