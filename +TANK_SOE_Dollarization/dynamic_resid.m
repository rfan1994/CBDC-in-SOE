...
residual(5) = lhs - rhs;
lhs = y(24);
rhs = T(4)*y(18)+y(24)*T(2)+y(17)+params(1)*params(11)*y(10)/y(54)+T(1)*(y(23)+(1-params(1))*y(27)+y(38)*params(1)*(1+y(44)));
residual(6) = lhs - rhs;
lhs = y(25);
...
residual(20) = lhs - rhs;
lhs = y(37)*T(32);
rhs = y(87)*params(2)*y(80)/y(56);
residual(21) = lhs - rhs;
residual(22) = y(42);
lhs = y(56)*(y(41)-y(11)/y(13))+y(40)-y(10)*(1-params(11))/y(54)+y(38)*(1+y(44));
