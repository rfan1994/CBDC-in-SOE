...
residual(21) = lhs - rhs;
residual(22) = y(42);
lhs = y(56)*(y(41)-(1-params(11))*y(11)/y(13))+y(40)-(1-params(11))*y(10)/y(54)+y(38)*(1+y(44));
rhs = y(39)*y(50)-y(61)-y(56)*params(21)/2*T(8);
residual(23) = lhs - rhs;
lhs = y(43);
rhs = T(10)^(params(12)/(params(12)-1));
residual(24) = lhs - rhs;
lhs = y(44);
...
residual(29) = lhs - rhs;
lhs = y(26);
rhs = y(26)*y(51)*T(14)+T(15)*T(16);
residual(30) = lhs - rhs;
lhs = y(22);
rhs = (1-params(14))*y(6)+y(23)*T(13);
residual(31) = lhs - rhs;
lhs = y(24);
rhs = y(15)*T(17)*T(18);
residual(32) = lhs - rhs;
...
rhs = y(53)*(y(53)-params(38))-T(19)/(y(24)*y(55));
residual(35) = lhs - rhs;
lhs = y(53);
rhs = y(54)*y(55)/y(12);
residual(36) = lhs - rhs;
lhs = T(1)*y(24)*y(55);
rhs = T(8)*params(1)*y(56)*params(21)/2+(1-params(1))*y(56)*params(20)/2*T(21)+(1-params(1))*y(56)*params(19)/2*T(20)+params(1)*params(11)*(y(10)/y(54)+y(56)*y(11)/y(13))+params(1)*y(56)*(y(41)-y(11))+(1-params(1))*y(56)*(y(32)-y(5)*y(9))+y(55)*y(17)+y(23)+(1-params(1))*y(27)+y(38)*params(1)*(1+y(44));
residual(37) = lhs - rhs;
lhs = 1;
